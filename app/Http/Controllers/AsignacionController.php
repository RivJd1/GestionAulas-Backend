...
class AsignacionController extends Controller
{
    ...
    {
        // LOG TEMPORAL: confirma qué llega realmente en el body antes de
        // validar. Revisa storage/logs/laravel.log después de arrastrar una
        // clase. Quítalo una vez confirmes que todo funciona.
        ...
        \Log::info('Asignacion@store - guardado en BD', $asignacion->fresh()->toArray());
    ...
    {
        // LOG TEMPORAL: confirma si la petición llega como PATCH real (header
        // sobrevivió) o como POST (cayó en la ruta de respaldo de routes/api.php),
        // y qué trae el body. Revisa storage/logs/laravel.log. Quítalo después.
        ...
        \Log::info('Asignacion@update - guardado en BD', $asignacion->fresh()->toArray());
